...
<body class="bg-light">
    ...
    <nav class="bg-dark py-2">
        <div class="container text-center">
            ...
            <a href="{{ url('tag') }}" class="text-white mx-3 font-weight-bold">Tag</a>
    ...
    <div class="container my-5">
        <div class="bg-white p-4 rounded shadow">
            ...
            @if (Auth::check())
                <p>Olá, {{ Auth::user()->name }}! Bem-vindo ao meu site.</p>
            @else
                <p>Faça login no site para conseguir acessar os conteúdos.</p>
            @endif
        </div>
    </div>
